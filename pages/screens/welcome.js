  ...
  return (
    <Element name="welcome">
      <div className=' bg-[url("/bg2.png")] bg-cover bg-center text-background m-0  h-[100%] w-[100%] overflow-hidden '>
        <div className="md:grid hidden md:grid-cols-2 p-4 mt-42 space-x-20 ">
        ...
        <div className="flex flex-col items-end md:hidden p-6">
          <div className="md:col-span-1 font-['Exo 2'] text-end">
            <div className="text-3xl font-bold uppercase mb-6  ">
              <p>Welcome to</p>
              <p>Modern Clinic</p>
            </div>
